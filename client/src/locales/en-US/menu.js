export default {
  ...
  'app.header.system': 'system',
  'app.menu.system.table_general.crud_user':'user',
  'app.menu.system.table_general.crud_dict':'dict',
  'app.menu.system.table_general.crud_office':'office',
};
